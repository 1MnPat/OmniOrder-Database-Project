...
-- 1. LOOKUP TABLES
-- ======================================================
-- Updated roles: Admin, Manager (Seller), Customer (User), Sales_Rep
INSERT INTO USER_ROLES (role_id, role_name) VALUES (1, 'Admin');
INSERT INTO USER_ROLES (role_id, role_name) VALUES (2, 'Manager'); 
...
-- ======================================================
-- 2. USERS (Categorized by new Amazon-style roles)
-- ======================================================
-- Admin (You)
...
-- Managers (The Sellers/Brand Owners)
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (102, 'Alice', 'Smith', 'alice@brand_a.com', 'pass', 2);
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (106, 'Edward', 'Norton', 'edward@brand_b.com', 'pass', 2);

-- Sales Reps
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (110, 'Ian', 'Curtis', 'ian@sales.com', 'pass', 4);

-- Customers (The Buyers)
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (103, 'Bob', 'Jones', 'bob@test.com', 'pass', 3);
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (104, 'Charlie', 'Brown', 'charlie@test.com', 'pass', 3);
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (105, 'Diana', 'Prince', 'diana@test.com', 'pass', 3);
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (107, 'Fiona', 'Gallagher', 'fiona@test.com', 'pass', 3);
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (108, 'George', 'Costanza', 'george@test.com', 'pass', 3);
INSERT INTO USERS (user_id, first_name, last_name, email, password, role_id) 
VALUES (109, 'Hannah', 'Baker', 'hannah@test.com', 'pass', 3);

-- ======================================================
-- 3. BRANDS (Linking Managers to their Companies)
-- ======================================================
INSERT INTO BRANDS (brand_id, brand_name, owner_id) VALUES (1, 'TechFlow Solutions', 102);
INSERT INTO BRANDS (brand_id, brand_name, owner_id) VALUES (2, 'Creative Canvas Co', 106);

-- ======================================================
-- 4. PRODUCTS (Now linked to specific Brands)
-- ======================================================
-- Brand 1 (TechFlow) Products
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (501, 'Smartphone Ultra', 999.99, 25, 10, 1);
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (502, 'Laptop Pro 16', 1500.00, 10, 10, 1);
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (507, 'Mechanical Keyboard', 85.00, 30, 10, 1);
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (509, 'Wireless Earbuds', 129.99, 60, 10, 1);

-- Brand 2 (Creative Canvas) Products
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (503, 'Abstract Canvas Art', 75.50, 5, 20, 2);
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (504, 'Digital Portrait Comm', 120.00, 99, 20, 2);

-- General/Service Products
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (505, 'Branded Hoodie', 45.00, 40, 30, NULL);
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (506, 'Leather Office Chair', 250.00, 15, 40, NULL);
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (508, 'Logo Design Service', 500.00, 99, 50, NULL);
INSERT INTO PRODUCTS (product_id, product_name, price, stock_quantity, category_id, brand_id) 
VALUES (510, 'Ergonomic Mouse', 55.00, 22, 40, NULL);

-- ======================================================
-- 5. TRANSACTIONS (Orders & Items)
-- ======================================================
-- Using sequence for order_id
INSERT INTO ORDERS (order_id, user_id, order_date, total_amount, status) 
VALUES (seq_order_id.NEXTVAL, 103, SYSDATE - 5, 1129.98, 'Shipped'); -- Order 100

INSERT INTO ORDERS (order_id, user_id, order_date, total_amount, status) 
VALUES (seq_order_id.NEXTVAL, 104, SYSDATE - 3, 45.00, 'Paid'); -- Order 101

INSERT INTO ORDERS (order_id, user_id, order_date, total_amount, status) 
VALUES (seq_order_id.NEXTVAL, 105, SYSDATE - 2, 1500.00, 'Pending'); -- Order 102

INSERT INTO ORDERS (order_id, user_id, order_date, total_amount, status) 
VALUES (seq_order_id.NEXTVAL, 107, SYSDATE - 1, 155.00, 'Shipped'); -- Order 103

INSERT INTO ORDERS (order_id, user_id, order_date, total_amount, status) 
VALUES (seq_order_id.NEXTVAL, 108, SYSDATE, 85.00, 'Processing'); -- Order 104

-- Order Items (Corrected order IDs to match sequence start)
